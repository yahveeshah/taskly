...
<head>
    ...
    <style>
        :root{--lavender:#C7A0CB;--navy:#000080;--yellow:#F6BE00;--lavender-light:#f0e8f2;--lavender-mid:#dcc8de}
        *{margin:0;padding:0;box-sizing:border-box}
        body{font-family:'DM Sans',sans-serif;background:var(--lavender-light);color:var(--navy);min-height:100vh}
        nav{display:flex;justify-content:space-between;align-items:center;padding:1.2rem 4rem;background:rgba(240,232,242,0.92);backdrop-filter:blur(12px);border-bottom:1px solid var(--lavender-mid);position:sticky;top:0;z-index:100;gap:1rem}
        ...
        .nav-links a.btn-register{background:var(--navy);border:1.5px solid var(--navy);box-shadow:0 6px 16px rgba(0,0,128,0.18);color:#fff;opacity:1;padding:0.5rem 1.4rem;border-radius:50px;font-size:0.85rem;font-weight:700;text-decoration:none;transition:all 0.2s}
        ...
        .flash-banner{background:#fff;border:1px solid var(--lavender-mid);border-left:4px solid var(--yellow);border-radius:12px;color:var(--navy);box-shadow:0 10px 24px rgba(0,0,128,0.08);font-size:0.88rem;font-weight:700;margin:1.25rem auto 0;max-width:1100px;padding:0.85rem 1rem}
        ...
        .hero p{color:rgba(0,0,128,0.65);font-size:1rem;line-height:1.9;margin-bottom:2.5rem;max-width:420px}
        ...
        .stat-card{background:#fff;border:1px solid var(--lavender-mid);border-radius:16px;padding:1.8rem 2rem;transition:transform 0.2s}
        ...
        .stat-label{font-size:0.82rem;color:rgba(0,0,128,0.58);margin-top:0.3rem;letter-spacing:0.5px}
        ...
        .f-card{background:#fff;border:1px solid var(--lavender-mid);border-radius:16px;padding:2.2rem;transition:all 0.2s;position:relative;overflow:hidden}
        ...
        .f-card p{color:rgba(0,0,128,0.6);font-size:0.85rem;line-height:1.8}
        ...
        footer{text-align:center;padding:2rem;color:rgba(0,0,128,0.38);font-size:0.78rem;letter-spacing:2px;text-transform:uppercase}
...
<section class="hero">
    ...
    <div class="hero-right">
        ...
        <div class="stat-card">
            ...
            <div class="stat-label">Your tasks, private to your account</div>
        </div>
        <div class="stat-card">
