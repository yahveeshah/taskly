...
<head>
    ...
    <style>
        :root{--lav:#C7A0CB;--navy:#000080;--yellow:#F6BE00;--ll:#f0e8f2;--lm:#dcc8de}
        *{margin:0;padding:0;box-sizing:border-box}
        ...
        .sidebar{width:220px;background:var(--navy);min-height:100vh;display:flex;flex-direction:column;padding:2rem 1rem;position:fixed;top:0;left:0;bottom:0}
        ...
        .sidebar nav a{color:rgba(255,255,255,0.68);text-decoration:none;padding:0.75rem 1rem;border-radius:10px;font-size:0.88rem;font-weight:500;display:flex;align-items:center;gap:0.7rem;transition:all 0.2s}
        .sidebar nav a:hover,.sidebar nav a.active{background:rgba(199,160,203,0.22);color:#fff}
        .sidebar-bottom{margin-top:auto;border-top:1px solid rgba(199,160,203,0.2);padding-top:1.2rem}
        ...
        .uname{font-size:0.82rem;font-weight:600;color:#fff;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;max-width:120px}
        ...
        .btn-logout{width:100%;background:rgba(231,76,60,0.15);color:#e74c3c;border:1.5px solid rgba(231,76,60,0.3);padding:0.6rem;border-radius:8px;font-size:0.82rem;font-weight:600;cursor:pointer;transition:all 0.2s;margin-top:0.5rem}
        .btn-logout:hover{background:#e74c3c;color:#fff}
        .main-wrap{margin-left:220px;flex:1;min-height:100vh;min-width:0}
        .topbar{background:#fff;border-bottom:1px solid var(--lm);padding:1.2rem 2.5rem;display:flex;align-items:center;justify-content:space-between;gap:1rem}
        .page-title{font-family:'Cormorant Garamond',serif;font-size:1.6rem;font-weight:700;color:var(--navy)}
        .topbar-right{font-size:0.82rem;color:var(--navy);opacity:0.55;white-space:nowrap}
        .content{padding:2.5rem}

        .ui-card{background:#fff;border:1.5px solid var(--lm);border-radius:14px;box-shadow:0 8px 24px rgba(0,0,128,0.04)}
        .ui-card:hover{box-shadow:0 10px 28px rgba(0,0,128,0.08)}
        ...
        .ui-button-primary{background:var(--navy);color:#fff}
        ...
        .ui-button-secondary:hover{background:var(--navy);color:#fff}
        .ui-button-warning{background:transparent;border-color:var(--yellow);color:#7a5c00}
        ...
        .ui-tag-priority-medium{background:#fff8e1;color:#7a5c00}
        .ui-tag-priority-low{background:#e8f0fe;color:var(--navy)}
        .ui-tag-status-pending{background:var(--ll);color:var(--navy)}
        .ui-tag-status-in_progress{background:#fff8e1;color:#7a5c00}
        ...
        .ui-field input,.ui-field textarea,.ui-field select{background:#faf6fb;border:2px solid var(--lav);border-radius:10px;color:var(--navy);font-size:0.88rem;outline:none;padding:0.72rem 0.9rem;transition:border-color 0.2s;width:100%}
        ...
        .ui-empty{text-align:center;padding:2.5rem 1rem;color:rgba(0,0,128,0.38);font-size:0.84rem}
        .flash-banner{background:var(--yellow);border:none;border-radius:50px;box-shadow:0 4px 16px rgba(0,0,128,0.15);color:var(--navy);font-size:0.88rem;font-weight:700;margin:1rem auto;max-width:420px;padding:0.75rem 2rem;text-align:center;width:max-content;animation:flash-fade 0.35s ease-in 2.65s forwards}
